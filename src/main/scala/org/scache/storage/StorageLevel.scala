 ...
 *
 * The [[org.scache.storage.StorageLevel]] singleton object contains some static constants
...
class StorageLevel private(
  ...
  private[scache] def memoryMode: MemoryMode = {
...
/**
 * Various [[org.scache.storage.StorageLevel]] defined and utility functions for creating
 * new storage levels.
 */
object StorageLevel {
  ...
  private[scache] val storageLevelCache = new ConcurrentHashMap[StorageLevel, StorageLevel]()

  private[scache] def getCachedStorageLevel(level: StorageLevel): StorageLevel = {
