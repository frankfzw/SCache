 ...
 */
private[scache] class DiskStore(conf: ScacheConf, diskManager: DiskBlockManager) extends Logging {

  private val minMemoryMapBytes = conf.getSizeAsBytes("scache.storage.memoryMapThreshold", "2m")
