...
import org.scache.storage.BlockManagerMessages.UpdateBlockInfo
...
private[scache] object BlockUpdatedInfo {

  private[scache] def apply(updateBlockInfo: UpdateBlockInfo): BlockUpdatedInfo = {
    BlockUpdatedInfo(
