...
class BlockManagerId private (
  ...
  def isDriver: Boolean = {
    executorId == ScacheConf.DRIVER_IDENTIFIER
  }
...
private[scache] object BlockManagerId {

  /**
   * Returns a [[org.scache.storage.BlockManagerId]] for the given configuration.
   *
   * @param execId ID of the executor.
   * @param host Host name of the block manager.
   * @param port Port of the block manager.
   * @return A new [[org.scache.storage.BlockManagerId]].
   */
