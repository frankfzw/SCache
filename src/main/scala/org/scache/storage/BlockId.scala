...
sealed abstract class BlockId {
  ...
  def isShuffle: Boolean = isInstanceOf[ScacheBlockId]
...
// org.apache.scache.network.shuffle.ExternalShuffleBlockResolver#getBlockData().
...
private[scache] case class TempLocalBlockId(id: UUID) extends BlockId {
  override def name: String = "temp_local_" + id
}

/** Id associated with temporary shuffle data managed as blocks. Not serializable. */
private[scache] case class TempShuffleBlockId(id: UUID) extends BlockId {
  override def name: String = "temp_shuffle_" + id
}

// Intended only for testing purposes
private[scache] case class TestBlockId(id: String) extends BlockId {
