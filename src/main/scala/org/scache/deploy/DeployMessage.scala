...
private[deploy] object DeployMessages {
  ...
  case class MapStart(appName: String, jobId: Int, shuffleId: Int, mapId: Int) extends FromDaemon
  case class MapEnd(appName: String, jobId: Int, shuffleId: Int, mapId: Int, sizes: Array[Long]) extends FromDaemon
