...
import org.scache.io.CompressionCodec
 ...
 */
private[scache] class SerializerManager(defaultSerializer: Serializer, conf: ScacheConf) {
  ...
  private[this] val compressBroadcast = conf.getBoolean("scache.broadcast.compress", true)
  // Whether to compress shuffle output that are stored
  private[this] val compressShuffle = conf.getBoolean("scache.shuffle.compress", true)
  // Whether to compress RDD partitions that are stored serialized
  private[this] val compressRdds = conf.getBoolean("scache.rdd.compress", false)
  // Whether to compress shuffle output temporarily spilled to disk
  private[this] val compressShuffleSpill = conf.getBoolean("scache.shuffle.spill.compress", true)
