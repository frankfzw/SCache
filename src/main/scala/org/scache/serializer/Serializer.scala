...
import org.scache.util.NextIterator

/**
 * :: DeveloperApi ::
 * A serializer. Because some serialization libraries are not thread safe, this class is used to
 * create [[org.scache.serializer.SerializerInstance]] objects that do the actual
 ...
 *
 * 1. a zero-arg constructor or a constructor that accepts a [[org.scache.util.ScacheConf]]
...
abstract class Serializer {
   ...
   */
  private[scache] def supportsRelocationOfSerializedObjects: Boolean = false
}
