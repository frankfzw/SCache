...
import org.scache.network.buffer.NettyManagedBuffer;

/**
 * A generic RPC which is handled by a remote {@link org.scache.network.server.RpcHandler}.
 * This will correspond to a single
 * {@link org.scache.network.protocol.ResponseMessage} (either success or failure).
 */
