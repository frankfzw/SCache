...
import static org.scache.network.sasl.ScacheSaslServer.*;
 ...
 */
public class ScacheSaslClient implements SaslEncryptionBackend {
  private final Logger logger = LoggerFactory.getLogger(ScacheSaslClient.class);
  ...
  public ScacheSaslClient(String secretKeyId, SecretKeyHolder secretKeyHolder, boolean encrypt) {
